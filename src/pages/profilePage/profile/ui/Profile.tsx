...
import { ProfileButton, IconButton, Input } from '@shared/ui/profile/index';
            ...
            <div className="profile__card">
                    ...
                    <div className="profile__additional-info profile__info">
                        {profileAdditionalFields.map((profileAdditionalField, index) => (
                            <div key={`profile__additional-field${index}`} className='profile__additional-field profile__field'>
                                ...
                                {profileAdditionalField.hasProfileButton && <ProfileButton size="small" action={() => navigate('/profile/balance')}>Перейти к балансу</ProfileButton>}
                            </div>
                        ))}
                    </div>
                ...
                <div className="profile__footer">
                    ...
                    <div className="profile__footer-button">
                        <ProfileButton variant="secondary" action={handleClick}>{mode === 'view' ? 'Редактировать профиль' : 'Сохранить данные профиля'}</ProfileButton>
                    </div>
                </div>
            </div>
        </div>
